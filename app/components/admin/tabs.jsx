    ...
    <>
      ...
      <div className="admin__inner__main__tabs">
        ...
        <div
          ...
          onClick={() => (window.location.href = "/justice/admin/departments")}
        >
        ...
        <div
          ...
          onClick={() =>
            (window.location.href = "/justice/admin/notifications")
          }
        >
          Notification{" "}
        ...
        <div
          ...
          onClick={() =>
            (window.location.href = "/justice/admin/access-control")
          }
        >
          Access Control
        </div>
