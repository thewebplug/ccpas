...
const Menu = ({ open, setOpen, classifyCaseFunction }) => {
    ...
    open && (
      <div className="menu-cover">
        <div className="menu-cover__menu">
          ...
          <div
            className="menu-cover__menu__menu-item"
          ...
          <div className="menu-cover__menu__menu-item" onClick={openModal}>
            <svg
              width="20"
              height="20"
              viewBox="0 0 24 24"
          ...
          >
            ...
            <svg
              ...
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              className={classify && "menu-cover__menu__menu-item__svg-rotate"}
            >
              <path
          ...
          {classify && (
            <>
              <div className="menu-cover__menu__menu-sub-item"
        ...
        <div className="menu-cover__modal" onClick={() => setOpen(false)}></div>
