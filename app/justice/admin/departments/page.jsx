"use client";
import { createDepartment, createSubDepartment, getDepartments } from "@/app/apis/departments";
...
export default function Departments() {
  ...
  const [subDepartmentDescription, setSubDepartmentDescription] = useState(null);
  const [subDepartmentLocation, setSubDepartmentLocation] = useState(null);

  const handleGetDepartment = async (e) => {
    // e.preventDefault()
    // setLoading(true)
    const response = await getDepartments(auth?.token);
  ...
  const handleCreateSubdepartment = async (e) => {
    ...
    e.preventDefault();
    setLoading(true);
    const response = await createSubDepartment(subDepartment, selectedDepartment, auth?.token);
    console.log("createDepartment", response);

    if (response?.data?.statusCode === 201) {
      setModalOpen2(false);

      alert("Sub Department created");
      setModalOpen(false)
      setModalOpen2(false)
      setModalOpen3(false)
    }
  ...
  return (
    <div className="departments">
      <div className="departments__header">
        ...
        <button
          className="departments__header__button"
      ...
      {modalOpen2 || modalOpen3 ? (
        <div className="departments__details-modal departments__details-modal2"></div>
      ) : (
        ""
      )}
              ...
              <div className="departments__details__body__members__table">
                ...
                <div className="departments__details__body__members__table__cards">
                  <div
                    className={
                      cardActive === 1
                        ? "departments__details__body__members__table__cards__card departments__details__body__members__table__cards__card-active"
                        : "departments__details__body__members__table__cards__card"
                    }
                    onClick={() =>
                      cardActive === 1 ? setCardActive(0) : setCardActive(1)
                    }
                  >
                  ...
                  <div
                    ...
                    onClick={() =>
                      cardActive === 2 ? setCardActive(0) : setCardActive(2)
                    }
                  >
                    <div className="departments__details__body__members__table__cards__card__title">
                      Cybercrime
                  ...
                  <div
                    ...
                    onClick={() =>
                      cardActive === 3 ? setCardActive(0) : setCardActive(3)
                    }
                  >
                    <div className="departments__details__body__members__table__cards__card__title">
                      Cybercrime
                      ...
                      <button onClick={() => setCardActive(0)}>
                        ...
                        >
                          <path
                            fill-rule="evenodd"
                            clip-rule="evenodd"
                            d="M12.4991 13.0607L7.02941 18.5304L5.96875 17.4697L11.4384 12.0001L5.96875 6.53039L7.02941 5.46973L12.4991 10.9394L17.9688 5.46973L19.0294 6.53039L13.5597 12.0001L19.0294 17.4697L17.9688 18.5304L12.4991 13.0607Z"
                            fill="white"
                          />
                        </svg>
                      </button>
                ...
                <div className="departments__details__body__members__table__body">
                  <div className="departments__details__body__members__table__body__inner">
                    ...
                    <div className="departments__details__body__members__table__body__inner__center">
                      132
                    </div>
                    <div className="departments__details__body__members__table__body__inner__center">
                      132
                    ...
                    <div className="departments__details__body__members__table__body__inner__title">
                    ...
                    <div className="departments__details__body__members__table__body__inner__actions">
                      ...
                      >
                        <path
                          d="M13 15.4998H14.6667M14.6667 15.4998H28M14.6667 15.4998V27.1665C14.6667 27.6085 14.8423 28.0325 15.1548 28.345C15.4674 28.6576 15.8913 28.8332 16.3333 28.8332H24.6667C25.1087 28.8332 25.5326 28.6576 25.8452 28.345C26.1577 28.0325 26.3333 27.6085 26.3333 27.1665V15.4998H14.6667ZM17.1667 15.4998V13.8332C17.1667 13.3911 17.3423 12.9672 17.6548 12.6547C17.9674 12.3421 18.3913 12.1665 18.8333 12.1665H22.1667C22.6087 12.1665 23.0326 12.3421 23.3452 12.6547C23.6577 12.9672 23.8333 13.3911 23.8333 13.8332V15.4998M18.8333 19.6665V24.6665M22.1667 19.6665V24.6665"
                          stroke="#667085"
                      ...
                      >
                        <path
                          d="M24.668 12.9999C24.8868 12.7811 25.1467 12.6074 25.4326 12.489C25.7186 12.3705 26.0251 12.3096 26.3346 12.3096C26.6442 12.3096 26.9507 12.3705 27.2366 12.489C27.5226 12.6074 27.7824 12.7811 28.0013 12.9999C28.2202 13.2188 28.3938 13.4786 28.5122 13.7646C28.6307 14.0506 28.6917 14.3571 28.6917 14.6666C28.6917 14.9761 28.6307 15.2826 28.5122 15.5686C28.3938 15.8546 28.2202 16.1144 28.0013 16.3333L16.7513 27.5833L12.168 28.8333L13.418 24.2499L24.668 12.9999Z"
                          stroke="#667085"
                          stroke-width="1.66667"
                          stroke-linecap="round"
                          stroke-linejoin="round"
      ...
      {modalOpen2 && (
        <div className="departments__new-dept">
          ...
          <form
            className="departments__new-dept__form"
            onSubmit={handleCreateDepartment}
          >
            <div>
              <label htmlFor="" className="departments__new-dept__form__label">
                Name of Department
              </label>

              <input
                type="text"
                className="departments__new-dept__form__input"
            ...
            <div>
              ...
              <textarea
                className="departments__new-dept__form__input departments__new-dept__form__textarea"
                name=""
                id=""
            ...
            <div>
              ...
              <div className="departments__new-dept__form__options">
                <div
                  className={
                    subDept && "departments__new-dept__form__options__active"
                  }
                ...
                <div
                  ...
                  onClick={() =>
                    subDept === false ? setSubDept("") : setSubDept(false)
                  }
                >
                  <svg
                    width="10"
            ...
            <button
              className="departments__new-dept__form__button"
              type="submit"
            >
      ...
      {modalOpen3 && (
        <div className="departments__new-dept">
          ...
          <form className="departments__new-dept__form" onSubmit={handleCreateSubdepartment}>
            <div>
              <label htmlFor="" className="departments__new-dept__form__label">
                Name of Department
              </label>
            ...
            <div>
              ...
              <input
                ...
                className="departments__new-dept__form__input"
                placeholder="Enter department location"
                value={subDepartmentLocation}
                onChange={(e) => setSubDepartmentLocation(e.target.value)}
                required
              />
            </div>
