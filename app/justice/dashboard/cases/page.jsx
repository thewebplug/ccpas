...
<path fill-rule="evenodd" clip-rule="evenodd" d="M12 7.5C13.104 7.5 14 6.604 14 5.5C14 4.396 13.104 3.5 12 3.5C10.896 3.5 10 4.396 10 5.5C10 6.604 10.896 7.5 12 7.5ZM12 10.5C10.896 10.5 10 11.396 10 12.5C10 13.604 10.896 14.5 12 14.5C13.104 14.5 14 13.604 14 12.5C14 11.396 13.104 10.5 12 10.5ZM10 19.5C10 18.396 10.896 17.5 12 17.5C13.104 17.5 14 18.396 14 19.5C14 20.604 13.104 21.5 12 21.5C10.896 21.5 10 20.604 10 19.5Z" fill="black"/>
        ...
        <div className="cases__table__body" onClick={() => window.location.href = "/justice/dashboard/case-details"}>
            <div>11-03-2024</div>
            <div>EF18964</div>
            <div>EFCC</div>
            <button className="cases__table__body__case-status cases__table__body__review">Under review</button>
            <button className="cases__table__body__accused-status cases__table__body__remanded">Remanded In Jail</button>
            <div>Cyber Crime</div>
            <div>Criminal Case</div>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M12 7.5C13.104 7.5 14 6.604 14 5.5C14 4.396 13.104 3.5 12 3.5C10.896 3.5 10 4.396 10 5.5C10 6.604 10.896 7.5 12 7.5ZM12 10.5C10.896 10.5 10 11.396 10 12.5C10 13.604 10.896 14.5 12 14.5C13.104 14.5 14 13.604 14 12.5C14 11.396 13.104 10.5 12 10.5ZM10 19.5C10 18.396 10.896 17.5 12 17.5C13.104 17.5 14 18.396 14 19.5C14 20.604 13.104 21.5 12 21.5C10.896 21.5 10 20.604 10 19.5Z" fill="black"/>
        ...
        <div className="cases__table__body" onClick={() => window.location.href = "/justice/dashboard/case-details"}>
            ...
            <div>EF18964</div>
            <div>EFCC</div>
            <button className="cases__table__body__case-status cases__table__body__filed">Filed in Court</button>
            <button className="cases__table__body__accused-status cases__table__body__wanted">Wanted</button>
            <div>Cyber Crime</div>
            <div>Criminal Case</div>
            <div>Ifesinachi Eze</div>
            <div className="cases__table__body__options">
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M12 7.5C13.104 7.5 14 6.604 14 5.5C14 4.396 13.104 3.5 12 3.5C10.896 3.5 10 4.396 10 5.5C10 6.604 10.896 7.5 12 7.5ZM12 10.5C10.896 10.5 10 11.396 10 12.5C10 13.604 10.896 14.5 12 14.5C13.104 14.5 14 13.604 14 12.5C14 11.396 13.104 10.5 12 10.5ZM10 19.5C10 18.396 10.896 17.5 12 17.5C13.104 17.5 14 18.396 14 19.5C14 20.604 13.104 21.5 12 21.5C10.896 21.5 10 20.604 10 19.5Z" fill="black"/>
        ...
        <div className="cases__table__body" onClick={() => window.location.href = "/justice/dashboard/case-details"}>
            ...
            <div>EF18964</div>
            <div>EFCC</div>
            <button className="cases__table__body__case-status cases__table__body__closed">Closed</button>
            <button className="cases__table__body__accused-status cases__table__body__acquitted">Acquitted</button>
            <div>Cyber Crime</div>
            <div>Criminal Case</div>
            <div>Ifesinachi Eze</div>
            <div className="cases__table__body__options">
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M12 7.5C13.104 7.5 14 6.604 14 5.5C14 4.396 13.104 3.5 12 3.5C10.896 3.5 10 4.396 10 5.5C10 6.604 10.896 7.5 12 7.5ZM12 10.5C10.896 10.5 10 11.396 10 12.5C10 13.604 10.896 14.5 12 14.5C13.104 14.5 14 13.604 14 12.5C14 11.396 13.104 10.5 12 10.5ZM10 19.5C10 18.396 10.896 17.5 12 17.5C13.104 17.5 14 18.396 14 19.5C14 20.604 13.104 21.5 12 21.5C10.896 21.5 10 20.604 10 19.5Z" fill="black"/>
        ...
        <div className="cases__table__body" onClick={() => window.location.href = "/justice/dashboard/case-details"}>
            ...
            <div>EF18964</div>
            <div>EFCC</div>
            <button className="cases__table__body__case-status cases__table__body__re-opened">Re-Opened</button>
            <button className="cases__table__body__accused-status cases__table__body__remanded">Remanded In Jail</button>
            <div>Cyber Crime</div>
            <div>Criminal Case</div>
            <div>Ifesinachi Eze</div>
