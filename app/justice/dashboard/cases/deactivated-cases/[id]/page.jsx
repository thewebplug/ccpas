...
<div className="deactivated-case-details__banner__details__created-by">Case File Created by:</div>
...
<path d="M3 4.5L6 7.5L9 4.5" stroke="#9E77ED" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <button className="deactivated-case-details__banner__actions__export">
...
<path d="M5 7.5L10 12.5L15 7.5" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <div className="deactivated-case-details__banner__actions__more"
...
Copy
          ...
          <div className="deactivated-case-details__grid__personal-details__image-grid">
            {[...singleCaseMughsots]?.slice(1, 4)?.map((item, index) => (
              <div className="deactivated-case-details__grid__personal-details__image-grid__image" key={index}>
                <Image
                  alt=""
                  src={`https://${item?.url}`}
                  objectFit="cover"
                ...
                <div className="deactivated-case-details__grid__personal-details__image-grid__image__overlay"
...
<label>Email</label>
<div className="deactivated-case-details__grid__personal-details__accused-details__underline">Frank.A@gmail.com </div>
<label htmlFor="">Status of Suspect:</label>
<button className="deactivated-case-details__grid__personal-details__accused-details__case-status">{singleCase?.accusedStatus}</button>
...
<div className="deactivated-case-details__grid__personal-details__accused-details__underline" key={index}>{item?.name}</div>
))}
  </div>
...
<path d="M16.5 9H11.5C10.12 9 9 10.115 9 11.49V14.48V14.98C9 16.355 10.12 17.47 11.5 17.47H12.25C12.385 17.47 12.565 17.56 12.65 17.67L13.4 18.665C13.73 19.105 14.27 19.105 14.6 18.665L15.35 17.67C15.445 17.545 15.595 17.47 15.75 17.47H16.5C17.88 17.47 19 16.355 19 14.98V11.49C19 10.115 17.88 9 16.5 9ZM14.5 14.875H11.5C11.295 14.875 11.125 14.705 11.125 14.5C11.125 14.295 11.295 14.125 11.5 14.125H14.5C14.705 14.125 14.875 14.295 14.875 14.5C14.875 14.705 14.705 14.875 14.5 14.875ZM16.5 12.375H11.5C11.295 12.375 11.125 12.205 11.125 12C11.125 11.795 11.295 11.625 11.5 11.625H16.5C16.705 11.625 16.875 11.795 16.875 12C16.875 12.205 16.705 12.375 16.5 12.375Z" fill="#334155"/>
          ...
          <div className="deactivated-case-details__grid__deactivated-case-details__attachments">
            ...
            <div className="deactivated-case-details__grid__deactivated-case-details__attachments__uploaded-files-grid">
              {singleCaseAttachment?.map((doc, index) => (
                <div className="deactivated-case-details__grid__deactivated-case-details__attachments__uploaded-files-grid__card" key={index}>
          ...
          <div className="deactivated-case-details__grid__deactivated-case-details__assets">
            ...
            {singleCase?.externalAssets &&
              ...
              <div className="deactivated-case-details__grid__deactivated-case-details__assets__inner__table-body"
              onClick={() =>
                window.open(
