...
export default function Profile() {
  ...
  return (
    <div className="profile">
      ...
      {tab === "Notifications" && (
        <div className="profile__title-group">
          <div>
            ...
            <div>
              Choose your preferred method and timing for notifications update
              your photo and personal details here.
            </div>
          </div>
          <div>
            <button>Cancel</button>
      ...
      {tab === "Work" && (
        <div className="profile__group-multiple">
          <div>
          ...
          <div>
            ...
            <input type="text" disabled value={user?.govId} />
          </div>
          <div>
          ...
          <div>
            ...
            <input type="text" disabled value={user?.department} />
          </div>
          <div>
            <label htmlFor="">Supervisor Email</label>
            <input type="text" disabled value={user?.supervisorEmail} />
          </div>
          <div>
          ...
          <div>
            ...
            <input type="text" disabled value={user?.doe} />
          </div>
        </div>
      )}
