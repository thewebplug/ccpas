...
export default function CreateCase() {
  ...
  const handleClassifyCase = async (classification) => {
    const response = await classifyCase(
      singleCase?.id,
      classification,
      auth?.token
    );
    ...
    <div className="case-details">
      ...
      <div className="case-details__banner">
        <div className="case-details__banner__details">
          {singleCase?.caseClass === "Confidential" ? (
          ...
          ) : singleCase?.caseClass === "Top secret" ? (
            <svg
              width="101"
              height="100"
              viewBox="0 0 101 100"
            ...
            >
              ...
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M94.4587 65.5838H90.7676C84.5768 81.7774 68.893 93.2776 50.5233 93.2776C32.1535 93.2776 16.4698 81.7774 10.279 65.5838H6.58789C12.9378 83.729 30.2107 96.7432 50.5233 96.7432C70.8358 96.7432 88.1088 83.729 94.4587 65.5838ZM94.4583 34.8301H90.7671C84.576 18.6371 68.8926 7.13745 50.5233 7.13745C32.154 7.13745 16.4706 18.6371 10.2794 34.8301H6.5883C12.9386 16.6856 30.2112 3.67188 50.5233 3.67188C70.8354 3.67188 88.108 16.6856 94.4583 34.8301Z"
                fill="#B1241D"
              ></path>
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M78.115 65.5883H23.209C28.5555 75.2415 38.8455 81.7767 50.662 81.7767C62.4784 81.7767 72.7685 75.2415 78.115 65.5883ZM77.8845 34.8343H23.4395C28.8477 25.4058 39.0131 19.0547 50.662 19.0547C62.3108 19.0547 72.4763 25.4058 77.8845 34.8343Z"
                fill="#B1241D"
              ></path>
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M88.5473 65.5834H87.2456C81.2388 79.8546 67.1237 89.8743 50.6682 89.8743C34.2128 89.8743 20.0976 79.8546 14.0908 65.5834H12.7892C18.8647 80.5348 33.5354 91.0769 50.6682 91.0769C67.8011 91.0769 82.4718 80.5348 88.5473 65.5834ZM88.5474 34.8296H87.2457C81.239 20.5583 67.1237 10.5385 50.6682 10.5385C34.2127 10.5385 20.0975 20.5583 14.0907 34.8296H12.7891C18.8646 19.8781 33.5353 9.33594 50.6682 9.33594C67.8012 9.33594 82.4719 19.8781 88.5474 34.8296Z"
                fill="#B1241D"
              ></path>
              <path
                d="M50.6281 74.8307L52.295 76.0437C52.5593 76.2402 52.9184 75.9759 52.8168 75.6642L52.1798 73.7059L53.8265 72.5336C54.0975 72.3438 53.962 71.9169 53.63 71.9169H51.6106L50.9533 69.8705C50.8517 69.5588 50.4112 69.5588 50.3096 69.8705L49.6455 71.9169H47.6262C47.2942 71.9169 47.1586 72.3438 47.4297 72.5336L49.0763 73.7059L48.4393 75.6642C48.3377 75.9759 48.6968 76.2334 48.9611 76.0437L50.6281 74.8307Z"
                fill="white"
              ></path>
              <path
                d="M50.632 29.9088L52.2989 31.1218C52.5632 31.3183 52.9224 31.054 52.8207 30.7423L52.1837 28.784L53.8304 27.6117C54.1014 27.422 53.9659 26.9951 53.6339 26.9951H51.6145L50.9572 24.9486C50.8556 24.6369 50.4151 24.6369 50.3135 24.9486L49.6494 26.9951H47.6301C47.2981 26.9951 47.1625 27.422 47.4336 27.6117L49.0802 28.784L48.4433 30.7423C48.3416 31.054 48.7007 31.3115 48.965 31.1218L50.632 29.9088Z"
                fill="white"
              ></path>
              <path
                d="M93.6652 60.042V43.1812H90.4336V40.3711H99.988V43.1812H96.7564V60.042H93.6652Z"
                fill="#B1241D"
              ></path>
              <path
                d="M81.041 60.042V40.3711H89.4714V43.1812H84.1322V48.38H88.3754V51.1901H84.1322V57.2318H89.4714V60.042H81.041Z"
                fill="#B1241D"
              ></path>
              <path
                d="M69.7051 60.0459V40.375H74.2856C77.4891 40.375 78.8661 41.8644 78.8661 44.8993V46.1077C78.8661 48.1309 78.2198 49.4236 76.8428 49.9856V50.0418C78.3884 50.5196 78.8942 51.9808 78.8942 54.2008V57.6573C78.8942 58.6127 78.9223 59.3152 79.2314 60.0459H76.0841C75.9155 59.5401 75.803 59.2309 75.803 57.6292V54.0322C75.803 52.2056 75.2691 51.6155 73.8641 51.6155H72.7962V60.0459H69.7051ZM72.7962 48.8054H73.9203C75.0724 48.8054 75.7749 48.2996 75.7749 46.7259V45.2084C75.7749 43.8034 75.2972 43.1851 74.2013 43.1851H72.7962V48.8054Z"
                fill="#B1241D"
              ></path>
              <path
                d="M63.3044 60.3227C60.3256 60.3227 58.752 58.5243 58.752 55.4893V44.9233C58.752 41.8883 60.3256 40.0898 63.3044 40.0898C66.2831 40.0898 67.8568 41.8883 67.8568 44.9233V47.0028H64.9342V44.7266C64.9342 43.4339 64.316 42.9 63.3887 42.9C62.4613 42.9 61.8431 43.4339 61.8431 44.7266V55.7141C61.8431 57.0068 62.4613 57.5126 63.3887 57.5126C64.316 57.5126 64.9342 57.0068 64.9342 55.7141V52.7073H67.8568V55.4893C67.8568 58.5243 66.2831 60.3227 63.3044 60.3227Z"
                fill="#B1241D"
              ></path>
              <path
                d="M48.7402 60.042V40.3711H57.1706V43.1812H51.8314V48.38H56.0747V51.1901H51.8314V57.2318H57.1706V60.042H48.7402Z"
                fill="#B1241D"
              ></path>
              <path
                d="M42.3024 60.3227C39.2675 60.3227 37.75 58.5243 37.75 55.3769V54.2529H40.6725V55.6017C40.6725 57.0068 41.2908 57.5126 42.2743 57.5126C43.2578 57.5126 43.8761 57.0068 43.8761 55.5455C43.8761 53.9157 43.2578 52.8759 41.2346 51.1055C38.6492 48.8293 37.8062 47.2276 37.8062 44.9795C37.8062 41.8883 39.408 40.0898 42.4148 40.0898C45.4216 40.0898 46.911 41.8883 46.911 45.0357V45.8506H43.9885V44.839C43.9885 43.4339 43.4265 42.9 42.4429 42.9C41.4594 42.9 40.8973 43.4339 40.8973 44.7828C40.8973 46.2159 41.5437 47.2557 43.567 49.026C46.1523 51.3022 46.9672 52.8759 46.9672 55.3207C46.9672 58.5243 45.3373 60.3227 42.3024 60.3227Z"
                fill="#B1241D"
              ></path>
              <path
                d="M22.9434 60.042L22.9434 40.3711H27.4958C30.5869 40.3711 32.1044 42.0853 32.1044 45.2326V47.1716C32.1044 50.3189 30.5869 52.0331 27.4958 52.0331H26.0345L26.0345 60.042H22.9434ZM26.0345 49.223H27.4958C28.4793 49.223 29.0132 48.7734 29.0132 47.3683V45.0359C29.0132 43.6308 28.4793 43.1812 27.4958 43.1812H26.0345V49.223Z"
                fill="#B1241D"
              ></path>
              <path
                d="M16.1617 60.3227C13.1267 60.3227 11.4688 58.5243 11.4688 55.3769L11.4688 45.0357C11.4688 41.8883 13.1267 40.0898 16.1617 40.0898C19.1966 40.0898 20.8546 41.8883 20.8546 45.0357V55.3769C20.8546 58.5243 19.1966 60.3227 16.1617 60.3227ZM16.1617 57.5126C17.1452 57.5126 17.7634 56.9787 17.7634 55.5736V44.839C17.7634 43.4339 17.1452 42.9 16.1617 42.9C15.1781 42.9 14.5599 43.4339 14.5599 44.839L14.5599 55.5736C14.5599 56.9787 15.1781 57.5126 16.1617 57.5126Z"
                fill="#B1241D"
              ></path>
              <path
                d="M3.98164 60.0459L3.98164 43.1851H0.75L0.75 40.375H10.3044V43.1851H7.07278L7.07278 60.0459H3.98164Z"
                fill="#B1241D"
              ></path>
              <path
                d="M30.4716 25.0061C29.6842 25.8005 28.4233 25.7826 27.5934 24.9602C26.7675 24.1416 26.7423 22.8848 27.5297 22.0903C28.2665 21.347 29.3389 21.2561 30.16 21.875L29.5325 22.5082C29.0611 22.1736 28.47 22.2114 28.0724 22.6126C27.593 23.0964 27.6509 23.8009 28.2015 24.3466C28.7561 24.8962 29.465 24.9518 29.9445 24.4681C30.3421 24.0669 30.3669 23.4755 30.0319 23.0033L30.6595 22.3701C31.2936 23.1934 31.2083 24.2627 30.4716 25.0061Z"
                fill="black"
              ></path>
              <path
                d="M34.2583 21.8061C33.3198 22.4641 32.0857 22.2473 31.4023 21.2725C30.7188 20.2977 30.9419 19.0727 31.8805 18.4147C32.8235 17.7534 34.0558 17.958 34.7392 18.9328C35.4227 19.9076 35.2014 21.1448 34.2583 21.8061ZM33.826 21.1894C34.4245 20.7698 34.447 20.0304 34.0274 19.4319C33.6078 18.8334 32.9113 18.6117 32.3128 19.0313C31.7188 19.4477 31.6899 20.1781 32.1096 20.7766C32.5292 21.3751 33.2321 21.6059 33.826 21.1894Z"
                fill="black"
              ></path>
              <path
                d="M39.3205 18.8654L36.4985 17.1186L37.6687 19.6339L36.9709 19.9586L35.2937 16.3538L36.1171 15.9707L38.8004 17.6294L37.6886 15.2396L38.3915 14.9126L40.0686 18.5174L39.3205 18.8654Z"
                fill="black"
              ></path>
              <path
                d="M42.2147 17.8232L41.4064 18.0579L40.2978 14.2398L42.7652 13.5233L42.969 14.2253L41.3099 14.707L41.5894 15.6695L42.9879 15.2634L43.1902 15.9601L41.7916 16.3662L42.2147 17.8232Z"
                fill="black"
              ></path>
              <path
                d="M45.9084 16.9668L45.0794 17.1123L44.3921 13.1963L45.2212 13.0508L45.9084 16.9668Z"
                fill="black"
              ></path>
              <path
                d="M48.7696 16.6543L47.3592 16.723L47.1659 12.7518L48.5763 12.6832C49.8373 12.6218 50.6399 13.3921 50.6961 14.5481C50.7524 15.704 50.003 16.5943 48.7696 16.6543ZM48.0419 13.4354L48.1646 15.9575L48.6901 15.9319C49.481 15.8934 49.8734 15.4142 49.8333 14.5901C49.7948 13.7992 49.3582 13.3714 48.5673 13.4099L48.0419 13.4354Z"
                fill="black"
              ></path>
              <path
                d="M54.7869 16.1825L54.7109 16.9094L52.0509 16.6312L52.4645 12.6769L55.086 12.9511L55.01 13.6781L53.2256 13.4914L53.1386 14.323L54.7577 14.4924L54.6823 15.2139L53.0631 15.0445L52.964 15.9918L54.7869 16.1825Z"
                fill="black"
              ></path>
              <path
                d="M58.4222 17.7723L57.3731 14.6235L56.6614 17.3049L55.9175 17.1075L56.9374 13.2647L57.8151 13.4976L58.8142 16.4898L59.4903 13.9422L60.2396 14.1411L59.2197 17.9839L58.4222 17.7723Z"
                fill="black"
              ></path>
              <path
                d="M62.1667 19.195L61.3979 18.8523L62.7076 15.9137L61.5645 15.4043L61.8733 14.7114L64.9333 16.0751L64.6245 16.7681L63.4764 16.2564L62.1667 19.195Z"
                fill="black"
              ></path>
              <path
                d="M65.0328 20.7331L64.3087 20.3039L66.336 16.8838L67.0601 17.313L65.0328 20.7331Z"
                fill="black"
              ></path>
              <path
                d="M68.3923 23.1206L68.679 22.2637L67.4586 21.3163L66.6951 21.8031L66.0259 21.2836L69.645 19.0599L70.3711 19.6236L69.1052 23.6741L68.3923 23.1206ZM69.4269 20.0542L68.0576 20.933L68.9062 21.5918L69.4269 20.0542Z"
                fill="black"
              ></path>
              <path
                d="M71.6844 26.34L69.9142 24.4778L72.7957 21.7385L73.3757 22.3485L71.0439 24.5651L72.2342 25.8173L71.6844 26.34Z"
                fill="black"
              ></path>
              <path
                d="M70.3663 75.2713C71.1537 74.4768 72.4146 74.4947 73.2445 75.3172C74.0704 76.1358 74.0956 77.3926 73.3082 78.187C72.5714 78.9303 71.499 79.0213 70.6778 78.4023L71.3054 77.7691C71.7768 78.1038 72.3679 78.0659 72.7655 77.6647C73.2449 77.181 73.187 76.4764 72.6364 75.9307C72.0818 75.3811 71.3729 75.3255 70.8934 75.8093C70.4958 76.2104 70.471 76.8018 70.8059 77.2741L70.1784 77.9073C69.5443 77.0839 69.6296 76.0146 70.3663 75.2713Z"
                fill="black"
              ></path>
              <path
                d="M66.5795 78.4713C67.5181 77.8132 68.7521 78.03 69.4356 79.0048C70.1191 79.9796 69.896 81.2046 68.9574 81.8627C68.0144 82.5239 66.7821 82.3194 66.0986 81.3446C65.4152 80.3698 65.6365 79.1325 66.5795 78.4713ZM67.0119 79.0879C66.4134 79.5075 66.3908 80.247 66.8105 80.8455C67.2301 81.4439 67.9266 81.6657 68.5251 81.2461C69.119 80.8296 69.148 80.0992 68.7283 79.5007C68.3087 78.9023 67.6058 78.6715 67.0119 79.0879Z"
                fill="black"
              ></path>
              <path
                d="M61.5174 81.4119L64.3394 83.1588L63.1692 80.6434L63.867 80.3187L65.5442 83.9235L64.7208 84.3066L62.0375 82.6479L63.1493 85.0377L62.4464 85.3648L60.7693 81.76L61.5174 81.4119Z"
                fill="black"
              ></path>
              <path
                d="M58.6232 82.4541L59.4315 82.2194L60.5401 86.0376L58.0727 86.754L57.8689 86.0521L59.528 85.5703L59.2485 84.6078L57.85 85.0139L57.6477 84.3173L59.0463 83.9112L58.6232 82.4541Z"
                fill="black"
              ></path>
              <path
                d="M54.9295 83.3105L55.7585 83.165L56.4457 87.081L55.6167 87.2265L54.9295 83.3105Z"
                fill="black"
              ></path>
              <path
                d="M52.0683 83.623L53.4787 83.5544L53.672 87.5255L52.2616 87.5942C51.0006 87.6556 50.198 86.8852 50.1418 85.7293C50.0855 84.5733 50.8349 83.6831 52.0683 83.623ZM52.796 86.8419L52.6733 84.3198L52.1478 84.3454C51.3569 84.3839 50.9644 84.8632 51.0046 85.6873C51.0431 86.4782 51.4797 86.906 52.2706 86.8675L52.796 86.8419Z"
                fill="black"
              ></path>
              <path
                d="M46.0509 84.0949L46.127 83.3679L48.787 83.6462L48.3734 87.6004L45.7519 87.3262L45.8279 86.5992L47.6123 86.7859L47.6993 85.9543L46.0801 85.7849L46.1556 85.0635L47.7748 85.2328L47.8739 84.2856L46.0509 84.0949Z"
                fill="black"
              ></path>
              <path
                d="M42.4157 82.5051L43.4648 85.6538L44.1765 82.9724L44.9204 83.1699L43.9005 87.0127L43.0228 86.7797L42.0237 83.7875L41.3476 86.3351L40.5983 86.1362L41.6182 82.2934L42.4157 82.5051Z"
                fill="black"
              ></path>
              <path
                d="M38.6712 81.0824L39.44 81.425L38.1303 84.3636L39.2734 84.873L38.9646 85.566L35.9046 84.2022L36.2134 83.5093L37.3615 84.021L38.6712 81.0824Z"
                fill="black"
              ></path>
              <path
                d="M35.8051 79.5442L36.5291 79.9734L34.5019 83.3936L33.7778 82.9644L35.8051 79.5442Z"
                fill="black"
              ></path>
              <path
                d="M32.4456 77.1567L32.1589 78.0137L33.3792 78.9611L34.1428 78.4742L34.812 78.9938L31.1929 81.2175L30.4668 80.6538L31.7327 76.6032L32.4456 77.1567ZM31.411 80.2231L32.7803 79.3443L31.9317 78.6855L31.411 80.2231Z"
                fill="black"
              ></path>
              <path
                d="M29.1535 73.9374L30.9237 75.7995L28.0421 78.5389L27.4622 77.9288L29.794 75.7122L28.6036 74.46L29.1535 73.9374Z"
                fill="black"
              ></path>
            </svg>
          ) : (
        ...
        <div className="case-details__banner__actions">
          ...
          <div className="case-details__banner__actions__case-status__options">
          <button className="case-details__banner__actions__case-status__options__status">
...
<path d="M3 4.5L6 7.5L9 4.5" stroke="#9E77ED" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <button className="case-details__banner__actions__case-status__options__export">
            Export{" "}
            <svg
              width="20"
              height="20"
          ...
          <div
            className="case-details__banner__actions__case-status__options__more"
          ...
          <Menu
            open={menuActive}
            setOpen={setMenuActive}
            classifyCaseFunction={handleClassifyCase}
        ...
        <div className="case-details__grid__personal-details">
          ...
          <div className="case-details__grid__personal-details__image-grid">
            {[...singleCaseMughsots]?.slice(1, 4)?.map((item, index) => (
              <div
                className="case-details__grid__personal-details__image-grid__image"
                key={index}
              >
                <Image
                  alt=""
                ...
                {singleCaseMughsots?.length > 4 && index === 2 ? (
                  <div
                    className="case-details__grid__personal-details__image-grid__image__overlay"
          ...
          <div className="case-details__grid__personal-details__accused-details">
            ...
            <label>Email</label>
            <div className="case-details__grid__personal-details__accused-details__underline">
              Frank.A@gmail.com{" "}
            </div>
            <label htmlFor="">Status of Suspect:</label>
            <button className="case-details__grid__personal-details__accused-details__case-status">
            ...
            {singleCase?.__associate__?.map((item, index) => (
              <div
                className="case-details__grid__personal-details__accused-details__underline"
                key={index}
              >
                {item?.name}
              </div>
          ...
          <div className="case-details__grid__case-details__attachments">
            ...
            <div className="case-details__grid__case-details__attachments__uploaded-files-grid">
              {singleCaseAttachment?.map((doc, index) => (
                <div
                  className="case-details__grid__case-details__attachments__uploaded-files-grid__card"
                  key={index}
                >
            ...
            <div className="case-details__grid__case-details__assets__inner">
              {singleCase?.externalAssets &&
                singleCase?.externalAssets?.map((item, index) => (
                  <div
                    className="case-details__grid__case-details__assets__inner__table-body"
                    onClick={() =>
                      window.open(
