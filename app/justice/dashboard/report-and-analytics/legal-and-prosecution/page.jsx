...
export default function CreateCase() {
  ...
  useEffect(() => {
    ...
    const myChart = new Chart(ctx, {
      type: "bar",
      data: {
        labels: ["Financial Intelligence Unit", "Forensic and Accounting Unit", "Bank Fraud Unit", "Advance Fee Fraud (AFF)", "CTGI"],
        datasets: [
          {
            label: "Sept 2024",
            data: [750, 980, 1000, 1500, 890, 890, 820],
            borderWidth: 1,
    ...
    <div className="reports">
      ...
      <div className="reports__inner">
        <div className="reports__inner__filter">
          ...
          >
            <option value="Criminal Case Received">
...
<div>From: </div>
      ...
      <input type="date" name="" id="" value={to}  ref={dateInputRef2}
        ...
        dropDown === "Criminal Case Received" ? (
          <div className="reports__inner__tables">
            <div className="reports__inner__table reports__inner__investigation-table">
              <div className="reports__inner__table__header">
                <div className="reports__inner__table__xtra-large">Cer No</div>
                <div className="reports__inner__table__large reports__inner__table__center">
                  Amount Involved (Naira)
                </div>
                <div className="reports__inner__table__large reports__inner__table__center">
                  Amount Involved (Other)
                </div>
                <div className="reports__inner__table__xtra-large">
                  Property Involved
                </div>
                <div className="reports__inner__table__large reports__inner__table__center">
                  Date received for Advice
                </div>
                <div className="reports__inner__table__xtra-large reports__inner__table__center">
                  Investigating Section
                </div>
                <div className="reports__inner__table__xtra-large reports__inner__table__center">
                  Investigating officer(S)
                </div>
                <div className="reports__inner__table__xtra-large">Command</div>
                <div className="reports__inner__table__large reports__inner__table__center">
                  Date assigned to Counsel
                </div>
                <div className="reports__inner__table__xtra-large">Team</div>
                <div className="reports__inner__table__large reports__inner__table__center">
                  Prosecuting Counsel
                </div>
              </div>
              <div className="reports__inner__table__body">
                <div className="reports__inner__table__body__inner">
                  ...
                  <div className="reports__inner__table__xtra-large">Foreign Asset Team</div>
                  <div className="reports__inner__table__large reports__inner__table__center">
                  Adewumi Oloye
                  </div>
                </div>
        ...
        {currentType === "Analytics" &&
        dropDown === "Legal Advice" ? (
          <div className="reports__inner__tables">
            <div className="reports__inner__table reports__inner__investigation-table">
              <div className="reports__inner__table__header">
                <div className="reports__inner__table__xtra-large">Cer No</div>
                <div className="reports__inner__table__large reports__inner__table__center">
                Date Legal was GIVEN
                </div>
                <div className="reports__inner__table__large reports__inner__table__center">
                Date Legal was GIVEN
                </div>
              ...
              <div className="reports__inner__table__body">
                <div className="reports__inner__table__body__inner">
                <div className="reports__inner__table__xtra-large reports__inner__table__center">EFCC/ABJ/CTGI/012/2024</div>
                <div className="reports__inner__table__large reports__inner__table__center reports__inner__table__bold">
                Mon 21
                </div>
                <div className="reports__inner__table__large reports__inner__table__center reports__inner__table__bold">
                ...
                <div className="reports__inner__table__xtra-large">
                Responsible Financial Accountinng
                </div>
                </div>
                <div className="reports__inner__table__body__inner">
                <div className="reports__inner__table__xtra-large reports__inner__table__center">EFCC/ABJ/CTGI/012/2024</div>
